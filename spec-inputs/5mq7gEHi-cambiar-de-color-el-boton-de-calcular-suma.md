# SpecKit Input — Cambiar de color el botón de "Calcular Suma"

## Trello Metadata

- Trello Card ID: `5mq7gEHi`
- Trello Card URL: https://trello.com/c/5mq7gEHi/4-cambiar-de-color-el-bot%C3%B3n-de-calcular-suma
- Source: Trello
...
Título:
Cambiar de color el botón de "Calcular Suma"
